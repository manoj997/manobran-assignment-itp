...
<html>
    ...
    <body>
        ...
        <table width="55%" >
            ...
            <tr>
                <td>
                    <a  href="admin_accounts_investment_add.jsp" style="text-decoration: none">
                        <center><img src="Icons/add.png" height="30%" width="40%"/></center>
                        <br>
                        <center><label>Add Investment</label></center>
                    </a>
                </td>
                <td>
                    <a  href="admin_accounts_investment_update.jsp" style="text-decoration: none">
                        <center><img src="Icons/update.png" height="30%" width="40%"/></center>
                        <br/>
                        <center><label>Update Investment</label></center>
            </a>
                </td>
