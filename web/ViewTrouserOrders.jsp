<%-- 
    Document   : ViewTrouserOrders
    Created on : Aug 24, 2018, 5:34:11 PM
    Author     : TOSHIBA
--%>
...
<%
        ...
        try {
             ...
             String query = "select * from trouser_order ";
...
%>
		...
		<td><%=resultSet.getString("Ddate") %></td>
                ...
                <td><a href="TrouserOrderEdit.jsp?id=<%=resultSet.getString("OrderID")%>"><button class="update" type="button">Update</button></a></td>
            </tr>
...
<a href="Trouser.jsp"><button class="button" type="button">Make order</button></a>
            </center>
<br>
