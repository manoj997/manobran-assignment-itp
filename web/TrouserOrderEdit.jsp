<%-- 
    Document   : TrouserOrderEdit
    Created on : Aug 24, 2018, 5:36:23 PM
    Author     : TOSHIBA
--%>
...
<center>
<form name="RegForm" method="POST" action="TrouserOrderUpdateHandler">
...
<%
			...
			try{
	 		        ...
	 		        Statement myStm= myCon.createStatement();
	 		       	String query  ="SELECT * FROM trouser_order WHERE OrderID='"+id+"'";
