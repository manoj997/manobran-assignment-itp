...
<html>
    ...
    <body>
        ...
        <body>
        <div align="center">
            <a  href="AttendInsert.jsp" style="text-decoration: none">
                <button class="button1" >Mark Attendance </button>
            </a>
            <br>
            <br>  
                   
            <a href="AttendShow.jsp" style="text-decoration: none">
                <button class="button1">See Attendance </button>
            </a>
            <br>
            <br>
