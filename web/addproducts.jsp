...
input[type=search]{ width: 500px;
    ...
    <body>
       ...
       <form  method="POST" action="AddProductsServlet">
           <table>
               <tr><td>Product ID</td>
                   <td><input type="text" name="productid" id="productid" placeholder="Product Id.."></td></tr>

               <tr><td>Product Name</td>
                   <td> <input type="text" name="productname" id="productname" placeholder="Your Product name.."></td></tr>

               <tr><td>Supplied Date</td>
               <td><input type="date" name="date" ></td></tr>
               <tr><td>Supplier Id</td>
               <td><input type="text" name="supplierid" id="supplierid" placeholder="Supplier Id.."></td></tr>
  ...
  <input type="submit" value="Submit"></form>
                <a href="addfinalgoods.jsp">Final goods</a> 
                <a href="addrawmaterials.jsp">Raw Materials </a> 
        ...
        <script>
            function Demo(){
                   ...
                   document.getElementById("productid").value="prod657";
                    document.getElementById("productname").value= "Formal Shirt";
                     document.getElementById("supplierid").value="sup657";
