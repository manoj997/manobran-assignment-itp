...
//            String id = "101";
        ...
        --%>
           ...
           <form  method="POST" action="AddRiderServlet" align="center">
           <table>
               <tr><td>Rider ID</td>
                   <td> <input type="text" name="r_id" placeholder="Your ID.."></td></tr>
               <tr><td>Rider Name</td>
                   <td><input type="text" name="name" placeholder="Name" ></td>


               <tr><td>Bike Number</td>
                   <td><input type="text" name="bike_no" placeholder="Bike Number.."></td></tr>
