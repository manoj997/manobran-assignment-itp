...
<html>
    ...
    <body>
        ...
        <table width="55%">
            ...
            <tr>
                <td>
                    <a  href="admin_accounts_expense_add.jsp" style="text-decoration: none">
                        <center><img src="Icons/add.png" height="30%" width="40%"/></center>
                        <br>
                        <center><label>Add Expenses</label></center>
                    </a>
                </td>
                <td>
                    <a  href="admin_accounts_expense_update.jsp" style="text-decoration: none">
                        <center><img src="Icons/update.png" height="30%" width="40%"/></center>
                        <br/>
                        <center><label>Update Expense</label></center>
            </a>
                </td>
                <td>
                    <a  href="admin_accounts_expense_delete.jsp" style="text-decoration: none">
                        <center><img src="Icons/Delete.png" height="30%" width="40%"/></center>
                        <br/>
                        <center><label>Delete Expense/s</label></center>
            </a>
                </td>
            </tr>
