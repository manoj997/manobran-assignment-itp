<%-- 
    Document   : DeleteBlouseOrder
    Created on : Aug 12, 2018, 9:52:54 AM
    Author     : TOSHIBA
--%>
...
%>
		...
		<td><%=resultSet.getString("Ddate") %></td>
                <td><a href="DeleteBlouseOrder?id=<%=resultSet.getString("OrderID")%>"><button class="delete" type="button">Delete</button></a></td>
            </tr>
