    ...
    <body>
        ...
        try{
            ...
            Statement stmt=con.createStatement();  
                            ResultSet rs=stmt.executeQuery("select e.Name,e.Eno,a.CheckIn,a.CheckOut from employee e,fullattendence a where e.Eno=a.Eno and e.Eno='"+eno+"' ");  
                            while(rs.next()){
                     %>
        ...
        <br>
        <br>
        <a href="AttendShow.jsp"><b>Go Back</b></a>
        </div>
                <footer class="foot">
