...
import Service.TrouserOrderUpdateService;
 ...
 * @author TOSHIBA
 */
public class TrouserOrderUpdateHandler extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            torder.setFees(fees);
             ...
             TrouserOrderUpdateService sous=new TrouserOrderUpdateService();
		if(sous.updateTrouserOrder(torder))
