...
import Service.ShalwarOrderService;
 ...
 * @author TOSHIBA
 */
public class ShalwarOrderHandler extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            ShalwarOrderService rs=new ShalwarOrderService();
                if(rs.insertShorder(shorder))
