...
import Service.ShirtOrderUpdateService;
 ...
 * @author TOSHIBA
 */
public class ShirtOrderUpdateHandler extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            ShirtOrderUpdateService sous=new ShirtOrderUpdateService();
		if(sous.updateShirtOrder(sorder))
