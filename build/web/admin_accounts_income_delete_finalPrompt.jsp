...
<html>
    ...
    <%
        int inc_id=Integer.parseInt(request.getParameter("income_id"));
        
    
        Statement st=conn.createStatement();
        String query=" DELETE FROM income WHERE income_id="+inc_id+" ";
        int result = st.executeUpdate(query);

       if (result > 0)
            response.sendRedirect("admin_accounts_income_delete.jsp");
