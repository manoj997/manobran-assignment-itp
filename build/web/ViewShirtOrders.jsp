<%-- 
    Document   : ViewShirtOrders
    Created on : Aug 11, 2018, 7:33:26 PM
    Author     : TOSHIBA
--%>
...
<%
        ...
        try {
             ...
             String query = "select * from shirt_order ";
...
%>
		...
		<td><%=resultSet.getString("Ddate") %></td>
                ...
                <td><a href="ShirtOrderEdit.jsp?id=<%=resultSet.getString("OrderID")%>"><button class="update" type="button">Update</button></a></td>
            </tr>
...
<a href="Shirt.jsp"><button class="button" type="button">Make order</button></a>
            </center>
<br>
