<%-- 
    Document   : Dress
    Created on : Aug 4, 2018, 11:37:46 AM
    Author     : TOSHIBA
--%>
      ...
      <div class="portfolio-items">
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="Shirt.jsp" >
              <div class="hover-text">
                <h4>Men's Shirt</h4>
                <small>Select  Design</small>
              </div>
          ...
          <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="Blouse.jsp">
              <div class="hover-text">
                <h4>Blouse</h4>
                <small>Select  Design</small>
              </div>
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="Shalwar.jsp">
              <div class="hover-text">
                <h4>Shalwar</h4>
                <small>Select  Design</small>
              </div>
          ...
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="Trouser.jsp">
              <div class="hover-text">
                <h4>Trousers</h4>
                <small>Select  Design</small>
              </div>
