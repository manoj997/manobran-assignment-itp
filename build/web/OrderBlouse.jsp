...
<center>
        <script>
function setValue() {
    document.getElementById("ordid").value = "Blouse 4";
    ...
    document.getElementById('slength').value = '17';
    ...
    document.getElementById("fees").value = "2000.00";
  
}
</script>
    <input type="button" name="set_Value" id="set_Value" value="Demo" onclick="setValue()" />
            <form name="RegForm" method="POST" action="BlouseOrderHandler">
