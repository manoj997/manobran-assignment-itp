...
<html>
    ...
    <body>
        ...
        <div align="center">
            ...
            <a  href="EmpPer.jsp" style="text-decoration: none">
                <button class="button1" >Permanent Employee</button>
            </a>
            <br>
            <br>  
                   
            <a href="EmpTemp.jsp" style="text-decoration: none">
                <button class="button1">Temporary Employee</button>
            </a>
            <br>
            <br>
        
        <a href="EmpMain.jsp"><b>Go Back</b></a><br><br>
        </div>
            <footer class="foot">
