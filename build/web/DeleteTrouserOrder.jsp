<%-- 
    Document   : DeleteTrouserOrder
    Created on : Aug 24, 2018, 5:47:27 PM
    Author     : TOSHIBA
--%>
...
%>
		...
		<td><%=resultSet.getString("Ddate") %></td>
                <td><a href="DeleteTrouserOrder?id=<%=resultSet.getString("OrderID")%>"><button class="delete" type="button">Delete</button></a></td>
            </tr>
