                ...
                <table width="50%" border="5%">
                    ...
                    <%
                        try{
                            ...
                            ResultSet rs=stmt.executeQuery("select e.Name,e.Eno,p.Otr,p.Othrs,p.Total from employee e,temp p where e.Eno=p.Eno");  
                            while(rs.next()){
                     %>
                    ...
                    <tr>
                        ...
                        <td><%=rs.getString("p.Total") %></td>
                         <td><a href="paySalaryTemp.jsp?emp_no=<%=rs.getString("e.Eno")%>">Pay Now</a> </td>
