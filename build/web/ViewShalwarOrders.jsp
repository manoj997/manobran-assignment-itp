...
%>
		...
		<td><%=resultSet.getString("Ddate") %></td>
                ...
                <td><a href="ShalwarOrderEdit.jsp?id=<%=resultSet.getString("OrderID")%>"><button class="update" type="button">Update</button></a></td>
            </tr>
...
<a href="Shalwar.jsp"><button class="button" type="button">Make order</button></a>
            </center>
<br>
