<%-- 
    Document   : ViewShalwarOrders
    Created on : Aug 24, 2018, 3:28:29 PM
    Author     : TOSHIBA
--%>
...
%>
		...
		<td><%=resultSet.getString("OType") %></td>
		<td><%=resultSet.getString("ODate") %></td>
		<td><%=resultSet.getString("Email") %></td>
		<td><%=resultSet.getString("Payment") %></td>
               
                <td><a href="SupplyUpdate.jsp?id=<%=resultSet.getString("SupplyID")%>"><button class="update" type="button">Update</button></a></td>
                <td><a href="DeleteSupply?id=<%=resultSet.getString("SupplyID")%>"><button class="update" type="button">Delete</button></a></td>
            </tr>
