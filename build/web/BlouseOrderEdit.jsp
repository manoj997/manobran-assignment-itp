<%-- 
    Document   : BlouseOrderEdit
    Created on : Aug 24, 2018, 3:34:42 PM
    Author     : TOSHIBA
--%>
...
<center>
            <form name="RegForm" method="POST" action="BlouseOrderUpdateHandler">
			...
			try{
	 		        ...
	 		        Statement myStm= myCon.createStatement();
	 		       	String query  ="SELECT * FROM blouse_order WHERE OrderID='"+id+"'";
...
%> 
                ...
                <button class="button1" type="submit" onclick="return blouseValidate()" >Submit</button> &nbsp;&nbsp;&nbsp;&nbsp;
