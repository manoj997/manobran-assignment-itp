...
input[type=search]{ width: 500px;
    ...
    <body>
      ...
      <form  method="POST" action="UpdateRawMaterialsServlet">
           <table>
               <tr><td>Product ID</td>
                       <%
            ...
            try {
                 ...
                 String query = "select * from raw_materials r,products p where p.ProductId=r.ProductID and p.ProductId='"+productid+"'";
    ...
    <td><input type="text" name="productid" value="<%=resultSet.getString("ProductId") %>"></td></tr>
     ...
     <tr><td>Supplied Id</td>
        <td><input type="text" name="supplierid" value="<%=resultSet.getString("SupplierId") %>"></td></tr>
               
                 <tr><td>Purchased Quantity</td>
        <td><input type="text" name="quantity" value="<%=resultSet.getString("SuppliedQuantity") %>"></td></tr> 
                
               <tr><td>Available Stock</td>
                   <td> <input type="text" name="rstock" value="<%=resultSet.getString("AvailableStock") %>"></td></tr>
              ...
              <table>
                  ...
                  <td><form method="POST" action="DeleteRawMaterialsServlet?Id=<%=productid%>"><input type="submit" value="Delete"></form></td></table></div> </div>  
                   <%
