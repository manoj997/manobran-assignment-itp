...
<center>
            ...
            <script>
function setValue() {
    document.getElementById("ordid").value = "Shirt 4";
    document.getElementById('design').value = 'Design 3';
    document.getElementById('chest').value = '28';
    document.getElementById('shoulder').value = '10';
    document.getElementById('arms').value = '9';
    document.getElementById('slength').value = '25';
    ...
    document.getElementById("fees").value = "1200.00";
        ...
        <input type="button" name="set_Value" id="set_Value" value="Demo" onclick="setValue()" />
            ...
            <form name="RegForm" method="POST" action="ShirtOrderHandler">
              
                <p style="margin-left: 1px; color: black; font-size: 18px"><b>Shirt Order</b></p>
...
%>
                    <tbody>
                       <tr>
                        ...
                        <tr>
                            <td>Sleeve Length &nbsp;</td>
                            <td>
                                 <select name="slength" id="slength">
                                    <option value="10"> 10 </option>
                                    <option value="11"> 11 </option>
                                    <option value="12"> 12 </option>
                                    <option value="13"> 13 </option>
                ...
                <button class="button1" type="submit" onclick="return shirtValidate()" >Submit</button> &nbsp;&nbsp;&nbsp;&nbsp;
