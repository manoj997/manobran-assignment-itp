<%-- 
    Document   : ShirtOrderEdit
    Created on : Aug 11, 2018, 7:42:23 PM
    Author     : TOSHIBA
--%>
    ...
    <head>
        ...
        <script>
            function shirtValidate(){
                ...
                var slength = document.forms["RegForm"]["slength"].value;
...
<center>
<form name="RegForm" method="POST" action="ShirtOrderUpdateHandler">
...
<%
			...
			try{
	 		        ...
	 		        Statement myStm= myCon.createStatement();
	 		       	String query  ="SELECT * FROM shirt_order WHERE OrderID='"+id+"'";
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Sleeve Length &nbsp;</td>
                             ...
                             <td>
                                 <select name="slength">
                                    <option> <%=resultSet.getString("slength") %>  </option>
                                    <option> 10 </option>
                                    <option> 11 </option>
                                    <option> 12 </option>
                                    <option> 13 </option>
