<%-- 
    Document   : SelectCustomerType
    Created on : Sep 8, 2018, 1:11:33 PM
    Author     : TOSHIBA
--%>
...
<html>
    ...
    <body>
        ...
        <table width="55%" border="1">
            ...
            <tr>
                <td>
                    <a  href="RegisterUser.jsp" style="text-decoration: none">
                        <center><img src="Icons/add.png" height="30%" width="40%"/></center>
                        <br>
                        <center><label>New Customer</label></center>
                    </a>
                </td>
                <td>
                    <a  href="ViewCustomerDetails.jsp" style="text-decoration: none">
                        <center><img src="Icons/update.png" height="30%" width="40%"/></center>
                        <br/>
                        <center><label>Exist Customer</label></center>
            </a>
                </td>
