<%-- 
    Document   : DeleteShirtOrder
    Created on : Aug 11, 2018, 9:52:10 PM
    Author     : TOSHIBA
--%>
...
%>
		...
		<td><%=resultSet.getString("Ddate") %></td>
                <td><a href="DeleteShirtOrder?id=<%=resultSet.getString("OrderID")%>"><button class="delete" type="button">Delete</button></a></td>
            </tr>
