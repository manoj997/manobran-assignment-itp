...
<html>
    ...
    <%
        int exp_id=Integer.parseInt(request.getParameter("expense_id"));
        Statement st=conn.createStatement();
        String query=" DELETE FROM expense WHERE expense_id="+exp_id+" ";
        int result = st.executeUpdate(query);

       if (result > 0)
            response.sendRedirect("admin_accounts_expense_delete.jsp");
