<%-- 
    Document   : OrderTrouser
    Created on : Aug 8, 2018, 5:55:01 PM
    Author     : TOSHIBA
--%>
...
<center>
    <script>
function setValue() {
    document.getElementById("ordid").value = "Trouser 4";
    document.getElementById('design').value = 'Design 2';
    ...
    <input type="button" name="set_Value" id="set_Value" value="Demo" onclick="setValue()" />
            <form name="RegForm" method="POST" action="TrouserOrderHandler">
              
                <p style="margin-left: 1px; color: black; font-size: 18px"><b>Trouser Order</b></p>
...
%>
 ...
 <h6>*All Measurement In Inches</h6>
                ...
                <button class="button1" type="submit" onclick="return TrouserValidate()" >Submit</button> &nbsp;&nbsp;&nbsp;&nbsp;
