<%-- 
    Document   : DressDelete
    Created on : Aug 24, 2018, 2:47:23 PM
    Author     : TOSHIBA
--%>
      ...
      <div class="portfolio-items">
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="DeleteShirtOrder.jsp" >
          ...
          <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="DeleteBlouseOrder.jsp">
              <div class="hover-text">
                <h4>Blouse</h4>
                <small>Delete Order</small>
              </div>
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="DeleteShalwarOrder.jsp">
              <div class="hover-text">
                <h4>Shalwar</h4>
                <small>Delete Order</small>
              </div>
          ...
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="DeleteTrouserOrder.jsp">
              <div class="hover-text">
                <h4>Trousers</h4>
                <small>Delete Order</small>
              </div>
