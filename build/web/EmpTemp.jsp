...
<html>
    ...
    <body>
        ...
        <div align="center">
            <h2>Calculate salary for <i><u>temporary</u></i> Employee </h2>
        <form method="get" action="TempEmp" name="emp">
        <table border="3%">
            <tr><td>   Employee Number: </td><td><input type="text" name="eno"></td></tr>
            <tr><td>   Number of Hours: </td><td><input type="text" name="oth"></td></tr>
            <tr><td>   Hourly Rate: </td><td><input type="text" name="otr"></td></tr>
        </table>
        ...
        <a href="selectEmp.jsp"><b>Go Back</b></a>
            ...
            <div align="center">
            <h2>Temporary Employee Numbers</h2>
                <table width="20%" border="5%">
                    ...
                    <%
                        try{
                            ...
                            ResultSet rs=stmt.executeQuery("select Name,Eno from employee where Status='Temp' or Status='temporary'");  
                            while(rs.next()){
                     %>
